                    ...
                    <div>
                        <div className='my-6 flex flex-col'>
                            ...
                            <label className="input input-bordered flex items-center gap-2">
                                ...
                                <input {...register("fullname", { required: true })} type="text" className="grow dark:text-slate-950" placeholder="Username" />
                                {errors.fullname && <span className='text-xs text-orange-500'>This field is required</span>}
                            </label>
                        </div>
                        <div className='my-6 flex flex-col'>
                        ...
                        <div className='flex gap-3 mt-3 justify-between'>
                            <button className="btn btn-active py-1 bg-pink-600 hover:bg-pink-700 text-white" >Signup</button>
                            <p className='my-3'>Have Account?
